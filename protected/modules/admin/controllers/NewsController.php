    ...
    */
	...
	public function actionCreate()
	{
        ...
        if(isset($_POST['News']))
        {
            ...
            if($model->save()){
                if ($model->image){
                    $file = Yii::getPathOfAlias('webroot.images.news').DIRECTORY_SEPARATOR.$model->img;
	...
	public function actionUpdate($id)
	{
        ...
        if(isset($_POST['News']))
        {
            ...
            $model->image = CUploadedFile::getInstance($model,'image');
            if($del_img) {
                if(file_exists(Yii::getPathOfAlias('webroot.images.news').DIRECTORY_SEPARATOR.$model->img)){
