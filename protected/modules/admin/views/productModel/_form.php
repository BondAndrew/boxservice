...
Yii::app()->clientScript->registerScript('transliteration',
    "$(function(){
        $('#ProductModel_title').liTranslit({
            elAlias:$('#ProductModel_transliteration')
        });
    });",0);
?>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'nameBrand'); ?>
		<?php echo $form->dropDownList($model,'id_brand', $model->dopInf); ?>
