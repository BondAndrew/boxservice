...
<div class="wrapper">
    ...
    <div class="head_place">
        Главная >> главная >> <span>главная</span>
    </div>
    <div class="row row-grey clearfix">
        <div class="left">
            <?php $this->renderPartial('/blocks/brands_left',array('blockTitle' => 'новости по брендам'))?>
            <?php $this->renderPartial('/blocks/categories_left', array('blockTitle' => 'новости по категориям'))?>
